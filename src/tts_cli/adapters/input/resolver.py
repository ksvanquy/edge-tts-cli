...
from tts_cli.adapters.input.readers import InputReader, SrtInputReader, TxtInputReader, VttInputReader
...
class InputResolver:
    def __init__(self, readers: dict[str, InputReader] | None = None):
        self.readers = readers or {".txt": TxtInputReader(), ".srt": SrtInputReader(), ".vtt": VttInputReader()}
