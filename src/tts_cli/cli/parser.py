...
from tts_cli.cli.constants import DEFAULT_MAX_WORDS, DEFAULT_OUTPUT, DEFAULT_SUBTITLE_MODE, VERSION
from tts_cli.core.constants import (
    DEFAULT_PITCH, DEFAULT_RATE,
    DEFAULT_RETRIES, DEFAULT_TIMEOUT, DEFAULT_VOICE, DEFAULT_VOLUME,
)


def add_tts_options(parser: argparse.ArgumentParser) -> None:
    group = parser.add_argument_group("TTS")
    group.add_argument("--engine", choices=["edge", "google"], default="edge")
